...
get_user1_height = input('Enter user1 height in inches: ') #Enter and store user1 age
...
get_user2_height = input('Enter user2 height in inches: ') #Enter and store user2 age
